 ...
 * services.
 */
public abstract class BaseGoogleApiActivity extends AppCompatActivity {
    private static final String TAG = "BaseGoogleApiActivity";
        ...
        switch (requestCode) {
            case REQUEST_CODE_SIGN_IN:
                ...
                if (getAccountTask.isSuccessful()) {
                    System.out.println("ok sign result");
